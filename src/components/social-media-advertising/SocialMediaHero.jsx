...
import socialMediaBg from '../../assets/services/socialmedia.avif';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 xl:gap-4 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-300/90 font-medium max-w-xl leading-relaxed mb-14">
                            We don't just "post" on social media. We run high-precision ad campaigns that turn Sri Lankan browsers into buyers.
                        </p>
                    ...
                    <div className="relative mt-0 lg:mt-0">
                        ...
                        >
                            ...
                            <img
                                src={socialMediaBg}
                                alt="Social Media Advertising Sri Lanka"
