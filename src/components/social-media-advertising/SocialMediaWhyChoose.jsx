...
import { FaBullseye, FaChartBar, FaUserLock } from 'react-icons/fa';

const features = [
    {
        title: 'Precision Targeting',
        description: 'We don\'t waste money. We target the specific age, location, and interests of your Sri Lankan buyers.',
        icon: <FaBullseye />,
    },
    {
        title: 'Real ROI Tracking',
        description: 'Every Rupee is tracked. We show you exactly how many leads and sales your social ads generate.',
        icon: <FaChartBar />,
    },
    {
        title: 'Local Insights',
        description: 'We understand the Sri Lankan consumer mindset — knowing what makes them click and what makes them buy.',
        icon: <FaUserLock />,
    },
];
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Why iTEK</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                WHY HIRE <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">EXPERTS?</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                Running ads without a strategy is just an expensive hobby. We make sure your social media presence is a profitable investment.
                            </p>
                        </motion.div>
                    </div>
