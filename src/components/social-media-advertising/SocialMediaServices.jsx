...
import {
    FaFacebook, FaInstagram, FaLinkedin, FaChartPie, FaUsers, FaMousePointer
} from 'react-icons/fa';

const services = [
    {
        title: 'Meta Domination',
        description: 'Facebook and Instagram ads designed to reach every corner of the Sri Lankan market.',
        icon: <FaFacebook className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'LinkedIn B2B',
        description: 'Strategic targeting for professional services and corporate reach in Colombo and beyond.',
        icon: <FaLinkedin className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Precision Targeting',
        description: 'We find your actual buyers, not just people who "like" posts. Zero waste on reach.',
        icon: <FaUsers className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Pixel Tracking',
        description: 'Advanced data tracking to see exactly where your money goes and what it brings back.',
        icon: <FaChartPie className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Retargeting Flow',
        description: 'Staying in front of people who visited your site until they are ready to purchase.',
        icon: <FaMousePointer className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Visual Strategy',
        description: 'Creative content that stops the scroll and forces engagement in crowded feeds.',
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10">
                        CONVERSION <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">ENGINE</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Data-backed social advertising designed to dominate the local market and drive measurable bank deposits.
                    </p>
                </div>
