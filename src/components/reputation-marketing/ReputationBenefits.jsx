...
const reputationBenefits = [
    {
        title: 'HIGHER AD CONVERSION',
        description: 'Social proof makes your ads 3x more effective. We ensure your trust signals are front and center in every marketing campaign.'
    },
    {
        title: 'LOCAL BRAND DOMINANCE',
        description: 'Be the obvious choice in your Sri Lankan neighborhood by having more authentic, recent reviews than any competitor.'
    },
    {
        title: 'CUSTOMER LIFETIME VALUE',
        description: 'Build a community of advocates who don\'t just buy once, but actively sell your brand to their own networks.'
    }
];
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            <h3 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter uppercase leading-[0.8] italic">
                                BUILD <br />
                                <span className="text-red-600">ADVOCACY</span>
                            </h3>

                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Don't just collect stars. Build a brand that people are proud to recommend to their friends and colleagues.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">3X</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Ad Performance</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">100<span className="text-2xl">%</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Authentic Proof</div>
                                </div>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Growth Impact</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                WHY TRUST <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl uppercase">MATTERS?</span>
                            </h2>
...
export default ReputationBenefits;
