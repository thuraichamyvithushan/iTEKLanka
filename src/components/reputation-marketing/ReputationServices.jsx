...
import {
    FaStar, FaMapMarkerAlt, FaComments, FaBookOpen, FaUserCheck, FaShareAlt
} from 'react-icons/fa';

const services = [
    {
        title: 'Review Generation',
        description: 'We build automated systems to capture your happy customers\' feedback, ensuring your Google and Facebook profiles shine.',
        icon: <FaStar className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Citation Audit',
        description: 'We ensure your business name, address, and phone number are consistent across the web, boosting your local trust and SEO.',
        icon: <FaMapMarkerAlt className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Feedback Loops',
        description: 'Turn negative experiences into private growth opportunities before they reach the public search results.',
        icon: <FaComments className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Brand Storytelling',
        description: 'We help you craft and share the authentic stories of your impact, making your brand human and relatable.',
        icon: <FaBookOpen className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Trust Signal Audit',
        description: 'We analyze your website for "Trust Killers" and implement signals like visible reviews and security badges that drive sales.',
        icon: <FaUserCheck className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Social Proof Sync',
        description: 'Automating the display of your best recent reviews and mentions directly on your high-conversion pages.',
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        TRUST <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">MARKETING</span>
                    </h2>

                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Market your reputation, don't just protect it. We help you use your social proof to drive higher conversions and loyalty.
                    </p>
                </div>
