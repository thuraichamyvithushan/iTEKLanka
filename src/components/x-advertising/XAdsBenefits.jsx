...
const benefits = [
    {
        ...
        description: 'X is where people come to talk. We help you drop the corporate shield and actually chat with your customers, turning them into loyal fans.'
    },
    {
        title: 'REACH THE RIGHT AUDIENCE',
        description: 'You do not need to reach everyone—just the ones who want what you sell. We find them, talk to them directly, and bring them to your site.'
    },
    {
        title: 'BUILD GENUINE TRUST',
        description: 'When you show up consistently and answer people honestly on X, they start to trust you. And people buy from brands they trust.'
    }
];
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <h3 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter uppercase leading-[0.8] italic">
                                GET <br />
                                <span className="text-red-600">NOTICED.</span>
                            </h3>

                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Being active on X shows that your business is alive, listening, and ready to help. It's that simple.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    ...
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">More Clicks</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">24/7</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Brand Voice</div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                REAL <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">CONNECTION</span>
                            </h2>
