...
const features = [
    {
        title: 'Real Returns, No Bull',
        description: 'We care about actual sales and leads, not just how many "likes" a post gets. If our work doesn\'t grow your bottom line, we aren\'t doing our job right.',
        icon: <FaUserCheck />,
    },
    {
        title: 'We Know Sri Lanka',
        description: 'We understand what locals care about and how they talk on X. We write ads that sound like they belong in the timeline, not like a corporate brochure.',
        icon: <FaMapMarkedAlt />,
    },
    {
        title: 'Straight Shooting',
        description: 'No hidden fees. No confusing reports. We tell you exactly where your money goes and what you get out of it, plain and simple.',
        icon: <FaHandshake />,
    },
];
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                HONEST WORK. <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">REAL RESULTS.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                We believe marketing should be simple. Connect with people, tell them why you're great, and make it easy for them to buy. That's exactly what we do.
                            </p>
                        </motion.div>
                    </div>
