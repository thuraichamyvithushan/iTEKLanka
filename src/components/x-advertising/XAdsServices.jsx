...
import {
    FaComments, FaBullhorn, FaUsers, FaChartLine, FaVideo, FaSearchLocation
} from 'react-icons/fa';

const services = [
    {
        title: 'Promoted Posts',
        description: 'We place your best updates right in front of the people who are most likely to care about them and share them.',
        icon: <FaBullhorn className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Brand Conversations',
        description: 'We manage your brand voice so you sound like an actual human talking, creating trust and loyalty with your followers.',
        icon: <FaComments className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Follower Growth',
        description: 'We help you build a real audience step by step. No fake accounts, just actual people interested in your business.',
        icon: <FaUsers className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Video Ads',
        description: 'Short, snappy videos that stop people from scrolling past. We make sure your message is clear and memorable.',
        icon: <FaVideo className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Local Targeting',
        description: 'We point your ads straight at potential customers in Sri Lanka, making sure you do not waste money showing ads to the wrong crowd.',
        icon: <FaSearchLocation className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Clear Tracking',
        description: 'Every month, we show you exactly how many people saw your ads, clicked them, and bought from you. Simple tracking, no jargon.',
...
export default function XAdsServices() {
    return (
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        X <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">SERVICES</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Straight-forward advertising strategies that get your business noticed and bring paying customers to your door.
                    </p>
                </div>
