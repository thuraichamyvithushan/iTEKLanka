...
const seoFaqs = [
    {
        question: "Do people in Sri Lanka still use X?",
        answer: "Yes, definitely. While it might not have the massive sheer numbers of Facebook, X has a highly active, influential crowd in Sri Lanka. It's where news breaks, trends start, and direct conversations happen."
    },
    {
        question: "How much money do I need to spend on ads?",
        answer: "You don't need a huge budget to start. We can run effective campaigns that target a very specific group of people, making sure even a smaller budget brings in real, measurable results."
    },
    {
        question: "Is X just for news and politics?",
        answer: "Not at all. People use it to talk about movies, shopping, tech, food, and daily life. If you have a product people care about, they are already talking about it—we just help you join the chat."
    },
    {
        question: "Will you show me how it’s working?",
        answer: "Absolutely. Every month, we send you a simple, straightforward report. We show you how many people saw your ads and how many took action. No confusing buzzwords, just the facts."
    },
    {
        question: "Can I just use my personal account for my business?",
        answer: "You can, but a dedicated business profile looks far more professional and allows you to run targeted ads. We help set it up properly so you look like a trusted brand from day one."
    }
];
