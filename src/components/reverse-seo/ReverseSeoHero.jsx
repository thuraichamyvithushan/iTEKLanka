...
import reverseBg from '../../assets/services/reverseseo.jpg';

export default function ReverseSeoHero() {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 xl:gap-8 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-300/90 font-medium max-w-xl leading-relaxed mb-14">
                            We help you take control of your digital narrative, pushing negative results down and elevating the truths that define your business.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-5">
                            <Link to="/contact">
                                ...
                                >
                                    <span className="relative z-10">Defend My Brand</span>
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <img
                                src={reverseBg}
                                alt="Digital reputation management and reverse SEO"
                            ...
                            <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-black/80 to-transparent flex items-center justify-between px-10 text-xs font-mono text-white/70">
                                <div>CONTROL • DEFENSE • NARRATIVE</div>
                                <div className="flex items-center gap-4">
                                    <div className="flex gap-1.5">
                                        <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
                                        <div className="w-2 h-2 rounded-full bg-emerald-400/40" />
                                    </div>
                                    <span>100% DISCRETE</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
