...
import { FaUserShield, FaMask, FaHandshake } from 'react-icons/fa';

const whyUsPoints = [
    {
        title: 'Complete Discretion',
        description: 'Reputation management is sensitive. We work with strict confidentiality, ensuring your brand cleanup is never public knowledge.',
        icon: <FaUserShield />,
    },
    {
        title: 'Ethical Methods',
        description: 'We don\'t use "black hat" tricks that could get you banned. We use white-hat authority building to suppress unwanted results safely.',
        icon: <FaMask />,
    },
    {
        title: 'Proven Defense',
        description: 'We have successfully managed digital crises for high-profile clients in Sri Lanka, restoring their narrative back to the truth.',
        icon: <FaHandshake />,
    },
];

const ReverseSeoWhyTrust = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Why Our Defense?</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                CONTROL THE <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic text-4xl md:text-7xl uppercase">NARRATIVE.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                Your reputation is your most valuable asset. We protect it with specialized techniques that push negative links out of sight.
                            </p>
                        </motion.div>
                    </div>
...
export default ReverseSeoWhyTrust;
