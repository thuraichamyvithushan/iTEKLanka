...
const benefits = [
    {
        ...
        description: 'Skip the wait of organic growth. Your ads appear at the top of Google the moment your campaign goes live, driving traffic instantly.'
    },
    {
        title: 'BUDGET CONTROL',
        description: 'You decide exactly how much to spend per month, per day, or even per click. We optimize your budget to ensure zero waste.'
    },
    {
        title: 'HYPER-LOCAL TARGETING',
        description: 'Reach customers in specific cities, neighborhoods, or even within a certain distance from your physical store in Sri Lanka.'
    }
];
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Don't just spend money on ads—invest in a system that consistently brings in high-quality leads and sales for your business.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">10<span className="text-2xl">X</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Faster Results</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">100<span className="text-2xl">%</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Tracking Accuracy</div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">The Google Edge</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                WHY GOOGLE <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">WINS</span>
                            </h2>
