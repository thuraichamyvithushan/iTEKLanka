...
import adsbg from '../../assets/services/googleads2.png';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 xl:gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-300/90 font-medium max-w-xl leading-relaxed mb-14">
                            Stop guessing and start growing. We help Sri Lankan businesses reach motivated customers exactly when they are searching for what you offer.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-5">
                            <Link to="/contact">
                                ...
                                >
                                    <span className="relative z-10">Drive More Sales</span>
                    ...
                    <div className="relative mt-0 lg:mt-0">
                        ...
                        >
                            ...
                            <img
                                src={adsbg}
                                alt="Effective Google Ads Management"
                            ...
                            <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-black/80 to-transparent flex items-center justify-between px-10 text-xs font-mono text-white/70">
                                <div>STRATEGY • KEYWORDS • ROI</div>
                                <div className="flex items-center gap-4">
                                    <div className="flex gap-1.5">
                                        <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
                                        <div className="w-2 h-2 rounded-full bg-emerald-400/40" />
                                    </div>
                                    <span>99% PERFORMANCE FOCUS</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
