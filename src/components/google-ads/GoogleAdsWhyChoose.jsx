...
import { FaShieldAlt, FaChartPie, FaExternalLinkAlt } from 'react-icons/fa';

const features = [
    {
        title: 'Precision Targeting',
        description: 'Reach the exact audience you want based on location, keywords, demographics, and interests, for maximum efficiency.',
        icon: <FaShieldAlt />,
    },
    {
        title: 'Measurable ROI',
        description: 'Track every rupee of your ad spend. We provide transparent reports that show exactly how many clicks, calls, and sales your ads generate.',
        icon: <FaChartPie />,
    },
    {
        title: 'Instant Results',
        description: 'Unlike organic methods, Google Ads gives you immediate visibility at the top of search results, driving traffic from day one.',
        icon: <FaExternalLinkAlt />,
    },
];

const GoogleAdsWhyChoose = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">The iTek Advantage</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                RESULTS. <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">DRIVEN.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                We combine data-driven strategy with creative excellence to deliver Google Ads campaigns that actually grow your business.
                            </p>
                        </motion.div>
                    </div>
...
export default GoogleAdsWhyChoose;
