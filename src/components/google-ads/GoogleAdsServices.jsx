...
import {
    FaSearch, FaVideo, FaShoppingBag, FaAppStore, FaChartLine, FaBullseye
} from 'react-icons/fa';

const services = [
    {
        title: 'Search Network',
        description: 'Appear at the very top of Google Search results when potential customers are actively looking for your products or services.',
        icon: <FaSearch className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Display Network',
        description: 'Build brand awareness and reach people across millions of websites and apps with high-impact visual banners.',
        icon: <FaChartLine className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Video Advertising',
        description: 'Tell your story through compelling video ads on YouTube, the world\'s second-largest search engine, reaching your ideal viewers.',
        icon: <FaVideo className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Shopping Ads',
        description: 'Showcase your product inventory directly in Google search results with images, prices, and your business name to drive sales.',
        icon: <FaShoppingBag className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'App Campaigns',
        description: 'Promote your iOS or Android app across Google\'s largest properties, including Search, Play, YouTube, and the Display Network.',
        icon: <FaAppStore className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Performance Max',
        description: 'Leverage Google\'s best automation to find converting customers across all channels with a single, highly-optimized campaign.',
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        ADS <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">ECOSYSTEM</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        We manage every aspect of your Google Ads presence, ensuring your message reachers the right audience at the right time.
                    </p>
                </div>
