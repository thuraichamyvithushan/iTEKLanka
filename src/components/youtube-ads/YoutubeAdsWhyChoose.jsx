...
import { FaBullseye, FaFilm, FaChartPie } from 'react-icons/fa';

const features = [
    {
        title: 'Data-Driven Targeting',
        description: 'We don`t waste budget on broad audiences. We pinpoint your ideal customers across Sri Lanka to maximize your ROI and minimize ad spend waste.',
        icon: <FaBullseye />,
    },
    {
        title: 'Creative Excellence',
        description: 'Our team knows what makes users watch instead of skip. We design compelling campaigns that grab attention in the crucial first 5 seconds.',
        icon: <FaFilm />,
    },
    {
        title: 'Transparent Reporting',
        description: 'Full visibility into your campaign`s performance. You`ll see exactly how many views, clicks, and real business conversions you`re getting.',
        icon: <FaChartPie />,
    },
];

const YoutubeAdsWhyChoose = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                PROVEN. <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">PROFITABLE.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                We treat your ad budget like our own. Our focus is squarely on generating leads, sales, and measurable growth for your business.
                            </p>
                        </motion.div>
                    </div>
...
export default YoutubeAdsWhyChoose;
