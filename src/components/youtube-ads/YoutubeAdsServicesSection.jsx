...
import {
    FaVideo, FaBolt, FaSearch, FaUsers, FaPenNib, FaChartBar
} from 'react-icons/fa';

const services = [
    {
        title: 'In-Stream Ads',
        description: 'Capture attention before, during, or after videos with skippable or non-skippable ads designed for maximum impact.',
        icon: <FaVideo className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Bumper Ads',
        description: 'Deliver your core message in just 6 seconds. Perfect for building brand awareness and reaching massive audiences quickly.',
        icon: <FaBolt className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Video Discovery',
        description: 'Place your ads alongside related YouTube videos or in search results, capturing users precisely when they are looking for content.',
        icon: <FaSearch className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Precise Targeting',
        description: 'Reach exactly the right people based on their interests, search history, demographics, and even major life events.',
        icon: <FaUsers className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Creative Strategy',
        description: 'We don`t just run ads; we help you concept and script video content that actually stops people from hitting skip.',
        icon: <FaPenNib className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Advanced Analytics',
        description: 'Detailed, transparent reporting on views, watch time, and conversions so you know exactly what your budget is achieving.',
...
export default function YoutubeAdsServicesSection() {
    return (
                ...
                <div className="text-center mb-12 md:mb-30">
                    ...
                    >
                        ...
                        <span className="text-red-700 font-semibold text-sm uppercase tracking-[0.3em]">
                            DOMINATE VIDEO SEARCH
                        </span>
                    </motion.div>

                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        YOUTUBE ADS <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">SERVICES</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Data-driven video strategies engineered to capture attention, build trust, and drive meaningful conversions for your brand.
                    </p>
                </div>
