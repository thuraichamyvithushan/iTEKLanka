...
const benefits = [
    {
        title: 'MASSIVE REACH',
        description: 'YouTube is the world`s second-largest search engine. Tap into a vast audience of Sri Lankan users who watch video content daily.'
    },
    {
        title: 'COST-EFFECTIVE ENGAGEMENT',
        description: 'With TrueView ads, you only pay when someone chooses to watch your video, ensuring your budget is spent on genuinely interested viewers.'
    },
    {
        title: 'VISUAL STORYTELLING',
        description: 'Nothing builds brand connection quite like video. Showcase your products or services dynamically to build instant trust and desire.'
    }
];

const YoutubeAdsBenefits = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <h3 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter uppercase leading-[0.8] italic">
                                SCALE <br />
                                <span className="text-red-600">RAPIDLY</span>
                            </h3>

                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                YouTube advertising allows you to rapidly scale your brand awareness and customer acquisition with predictable, measurable results.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    ...
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Higher Intent</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">HD</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Visual Impact</div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Your Video Advantage</span>
                            </div>
...
export default YoutubeAdsBenefits;
