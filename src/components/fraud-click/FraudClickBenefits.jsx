...
const benefits = [
    {
        title: 'MAXIMIZED AD BUDGET',
        description: 'Stop paying for clicks that will never convert. We ensure every cent goes towards reaching actual potential customers.'
    },
    {
        title: 'ACCURATE ANALYTICS',
        description: 'Fake traffic distorts your data. We clean your traffic so you can make marketing decisions based on real user behavior.'
    },
    {
        title: 'COMPETITOR DEFENSE',
        description: 'Prevent rivals from maliciously draining your daily ad spend, ensuring your ads stay visible when real customers are searching.'
    }
];

const FraudClickBenefits = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <h3 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter uppercase leading-[0.8] italic">
                                SAVE <br />
                                <span className="text-red-600">YOUR BUDGET</span>
                            </h3>

                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Professional click fraud protection acts as a shield, securing your investment and artificially boosting your true conversion rates.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">20<span className="text-2xl">%</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Avg. Savings</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">24/7</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Active Defense</div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Your Shield Advantage</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                WHY IT <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">MATTERS</span>
                            </h2>
...
export default FraudClickBenefits;
