...
import {
    FaUserSecret, FaBan, FaShieldAlt, FaChartLine, FaSearchDollar, FaRobot
} from 'react-icons/fa';

const services = [
    {
        title: 'Bot Detection',
        description: 'Advanced algorithms identify and block malicious bots and scrapers from clicking your ads and draining your budget.',
        icon: <FaRobot className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Competitor Blocking',
        description: 'Stop rival businesses in Sri Lanka from continuously clicking your ads to exhaust your daily spend.',
        icon: <FaUserSecret className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'IP Blacklisting',
        description: 'Automatically blacklist suspicious IP addresses that exhibit fraudulent click behavior across your campaigns.',
        icon: <FaBan className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Refund Assistance',
        description: 'We gather detailed reports of invalid click activity to help you claim refunds from ad platforms like Google Ads.',
        icon: <FaSearchDollar className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Click Fraud Analysis',
        description: 'Deep dive analytics into your traffic sources to uncover hidden patterns of non-converting, fraudulent traffic.',
        icon: <FaChartLine className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: '24/7 Protection',
        description: 'Round-the-clock monitoring ensures your ad campaigns are constantly protected, even when you are asleep.',
...
export default function FraudClickServicesSection() {
    return (
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        FRAUD <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">DEFENSE</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Comprehensive solutions to identify, block, and report click fraud, saving your ad budget for real customers.
                    </p>
                </div>
