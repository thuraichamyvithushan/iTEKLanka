...
import fraudbg from '../../assets/services/ifc.jpg'; 
export default function FraudClickHeroSection() {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 xl:gap-4 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-300/90 font-medium max-w-xl leading-relaxed mb-14">
                            Don't let competitors and bots drain your ad budget. We block invalid clicks in real-time, ensuring your money is only spent on genuine customers.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-5">
                            <Link to="/contact">
                                ...
                                >
                                    <span className="relative z-10">Protect Your Ads</span>
