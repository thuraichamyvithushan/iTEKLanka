...
const fraudFaqs = [
    {
        question: "What exactly is click fraud?",
        answer: "Click fraud happens when bots, automated scripts, or competitors repeatedly click on your paid ads with no intention of buying. This drains your daily budget quickly and prevents real customers from seeing your ads."
    },
    {
        question: "How do you detect fake clicks?",
        answer: "Our software monitors dozens of data points per click, including IP addresses, click frequency, time on site, and mouse movement patterns to instantly identify non-human behavior."
    },
    {
        question: "Does this work for Google and Facebook Ads?",
        answer: "Yes, our protection services integrate seamlessly with major platforms like Google Ads, Facebook Ads, Bing Ads, and others to protect your entire digital marketing budget."
    },
    {
        question: "What happens when a fraudster is detected?",
        answer: "The moment a malicious IP or bot is identified, they are automatically added to your campaign's exclusion list in real-time. This means they will never see or be able to click your ad again."
    },
    {
        question: "Can I get my wasted money back from Google?",
        answer: "While we stop future fraud, we also provide you with comprehensive click forensics reports. You can submit these directly to Google to request refunds for clicks that slipped through their internal filters."
    }
];
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    >
                        ...
                        <span className="text-red-700 font-semibold text-sm uppercase tracking-[0.3em]">Protection Inquiries</span>
                    </motion.div>
