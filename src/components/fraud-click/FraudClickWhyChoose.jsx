...
const features = [
    {
        title: 'Authentic ROI',
        description: 'We focus on protecting your actual return on investment by ensuring your daily budget isn\'t wasted on fake clicks, leaving more money for real customers.',
        icon: <FaUserCheck />,
    },
    {
        title: 'SL Business Focus',
        description: 'We understand the specific threats and competitor tactics happening in the Sri Lankan market and build our defense strategies accordingly.',
        icon: <FaMapMarkedAlt />,
    },
    {
        title: 'Honest Partnership',
        description: 'We don\'t just sell a tool; we actively manage your protection and provide clear reports so you know exactly how much budget we\'ve saved you.',
        icon: <FaHandshake />,
    },
];

const FraudClickWhyChoose = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                PROVEN <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">PROTECTION.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                Don't let invisible competitors and malicious bots sabotage your campaigns. We guard your budget so you can focus on scaling.
                            </p>
                        </motion.div>
                    </div>
...
export default FraudClickWhyChoose;
