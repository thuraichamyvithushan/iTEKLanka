...
const benefits = [
    {
        title: 'TALK TO DECISION MAKERS',
        description: 'LinkedIn is the only platform where you can filter your audience by job title. Want to talk specifically to the IT Directors of companies with over 50 employees? We can do exactly that.'
    },
    {
        title: 'HIGHER QUALITY LEADS',
        description: 'While clicks on LinkedIn cost more than Facebook, the people clicking are in a "business mindset." A single good lead from LinkedIn can often pay for your entire yearly advertising budget.'
    },
    {
        title: 'SHORTEN SALES CYCLES',
        description: 'By consistently putting your company\'s expertise in front of targeted executives, they already know and respect your brand by the time your sales team reaches out to them.'
    }
];

const LinkedinAdsBenefits = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <h3 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter uppercase leading-[0.8] italic">
                                REAL <br />
                                <span className="text-red-600">INFLUENCE.</span>
                            </h3>

                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                When you advertise on LinkedIn, you are advertising in the digital boardroom. It is the fastest way to build B2B pipeline.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">2.5<span className="text-2xl">x</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Higher ROI</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">100<span className="text-2xl">%</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">B2B Focus</div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Why It Works</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                SMART <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">NETWORKING</span>
                            </h2>
...
export default LinkedinAdsBenefits;
