...
import { FaUserTie, FaBuilding, FaHandshake } from 'react-icons/fa';

const features = [
    {
        title: 'Bypass the Gatekeepers',
        description: 'Stop cold-calling receptionists who will not put you through. We deliver your business proposal directly to the screens of the exact executives you want to meet.',
        icon: <FaUserTie />,
    },
    {
        title: 'High-Value Connections',
        description: 'LinkedIn advertising isn\'t about getting thousands of cheap clicks; it is about getting five high-quality meetings that can actually double your revenue.',
        icon: <FaBuilding />,
    },
    {
        title: 'Professional Positioning',
        description: 'We ensure your company looks like a top-tier industry leader. From the ad copy to the design, everything is crafted to build immediate authority and trust.',
        icon: <FaHandshake />,
    },
];

const LinkedinAdsWhyChoose = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                SERIOUS. <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">BUSINESS.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                B2B marketing requires a different approach. We skip the viral trends and focus entirely on building profitable relationships with other companies.
                            </p>
                        </motion.div>
                    </div>
...
export default LinkedinAdsWhyChoose;
