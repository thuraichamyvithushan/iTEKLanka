...
import {
    FaBriefcase, FaEnvelopeOpenText, FaFilter, FaScroll, FaBullseye, FaChartBar
} from 'react-icons/fa';

const services = [
    {
        title: 'Precision Targeting',
        description: 'We do not just guess. We show your message specifically to people based on their job title, company size, and industry.',
        icon: <FaFilter className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Direct Messages',
        description: 'We craft polite, professional messages that go straight into the inbox of the exact person you want to talk to.',
        icon: <FaEnvelopeOpenText className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Easy Contact Forms',
        description: 'We use forms that fill themselves out with the user\'s LinkedIn info, making it incredibly easy for them to request a call with you.',
        icon: <FaScroll className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Thought Leadership',
        description: 'We help promote articles and insights from your company, proving to potential clients that you actually know what you are doing.',
        icon: <FaBriefcase className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Account Based Marketing',
        description: 'Have a dream client list? Provide it to us, and we will make sure those specific companies see your ads every day.',
        icon: <FaBullseye className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Clear ROI Reporting',
        description: 'LinkedIn ads cost more, so we track everything. You will know exactly which job titles are clicking your ads and turning into leads.',
...
export default function LinkedinAdsServices() {
    return (
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        B2B <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">SERVICES</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Straight-forward tactics designed to bypass gatekeepers and get your business in front of the people who make purchasing decisions.
                    </p>
                </div>
