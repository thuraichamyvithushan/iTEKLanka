...
import { FaUserShield, FaMicroscope, FaCheckDouble } from 'react-icons/fa';

const trustPoints = [
    {
        title: 'Manually Checked',
        description: 'No AI-generated fluff. Our SEO experts personally crawl your site to find issues that automated tools always miss.',
        icon: <FaMicroscope />,
    },
    {
        title: 'Actionable Clarity',
        description: 'We won\'t leave you with a list of codes. You get a plain-English roadmap of what to fix and how it helps your bottom line.',
        icon: <FaCheckDouble />,
    },
    {
        title: 'SL Business First',
        description: 'We understand the unique search behavior of Sri Lankan consumers and audit your site to capture them effectively.',
        icon: <FaUserShield />,
    },
];

const SeoAuditWhyTrust = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Why Our Audits?</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                DEPTH OVER <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic text-4xl md:text-7xl">AUTOMATION.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                Most agencies deliver "audits" in seconds. We take hours to ensure nothing is missed and your growth is guaranteed.
                            </p>
                        </motion.div>
                    </div>
                    ...
                    <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                        {trustPoints.map((point, index) => (
                            ...
                            >
                                ...
                                <h3 className="text-2xl md:text-3xl font-black mb-4 tracking-tight uppercase italic text-white">
                                    {point.title}
                                </h3>
...
export default SeoAuditWhyTrust;
