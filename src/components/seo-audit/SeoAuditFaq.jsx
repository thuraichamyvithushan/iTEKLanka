...
const auditFaqs = [
    {
        question: "Is this just a free online report?",
        answer: "Absolutely not. Free reports only show surface-level issues. Our experts use professional-grade tools and manual inspection to find the real technical and strategic problems holding you back."
    },
    {
        question: "How long does an audit take?",
        answer: "A comprehensive manual audit typically takes 5 to 7 business days to complete, as we personally analyze your data, competitors, and technical infrastructure."
    },
    {
        question: "What do I get at the end of the audit?",
        answer: "You get a detailed, prioritized action plan. We explain exactly what needs fixing, why it matters, and how to do it—all in plain English, not technical jargon."
    },
    {
        question: "Can you fix the issues you find in the audit?",
        answer: "Yes, we can. Once the audit is complete, we can provide a proposal to implement the entire roadmap for you as part of our SEO services."
    }
];
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    >
                        ...
                        <span className="text-red-700 font-semibold text-sm uppercase tracking-[0.3em]">Audit Inquiries</span>
                    </motion.div>

                    <h2 className="text-6xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        DEEP <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent italic">ANSWERS</span>
                    </h2>
                </div>
