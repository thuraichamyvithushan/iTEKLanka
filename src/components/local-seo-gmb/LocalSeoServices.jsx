...
import {
    FaMapMarkerAlt, FaStore, FaListUl, FaStar, FaPhoneAlt, FaMobileAlt
} from 'react-icons/fa';

const services = [
    {
        title: 'GMB Optimization',
        description: 'Complete audit and optimization of your Google Business Profile to maximize visibility and engagement.',
        icon: <FaStore className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Maps Ranking',
        description: 'Strategic positioning to get your business into the "Local Pack" and the top of Google Maps results.',
        icon: <FaMapMarkerAlt className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Local Citations',
        description: 'Consistent business information across all relevant Sri Lankan and global directories for trust.',
        icon: <FaListUl className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Review Strategy',
        description: 'Systematic approach to gathering and responding to positive customer reviews that build authority.',
        icon: <FaStar className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Local Content',
        description: 'Creating localized content that resonates with your specific service areas and target demographics.',
        icon: <FaMobileAlt className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Click-to-Call',
        description: 'Optimization for mobile users looking for immediate solutions nearby, driving direct leads to you.',
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10">
                        LOCAL <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">EXCELLENCE</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Specialized Google My Business optimization strategies to ensure your brand stands out in every local search.
                    </p>
                </div>
