...
import localSeoBg from '../../assets/services/localseo.jpg';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 xl:gap-4 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-300/90 font-medium max-w-xl leading-relaxed mb-14">
                            We optimize your Google Business Profile and Maps presence to ensure when customers nearby search, your business is the only choice they see.
                        </p>
                    ...
                    <div className="relative mt-0 lg:mt-0">
                        ...
                        >
                            ...
                            <img
                                src={localSeoBg}
                                alt="Local SEO and GMB Optimization"
