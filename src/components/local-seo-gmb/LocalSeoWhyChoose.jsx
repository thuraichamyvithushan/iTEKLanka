...
import { FaMapMarkerAlt, FaChartLine, FaCheckDouble } from 'react-icons/fa';

const features = [
    {
        title: 'Local Visibility',
        description: 'We ensure your business appears at the top when local customers are ready to buy.',
        icon: <FaMapMarkerAlt />,
    },
    {
        title: 'Data-Driven Results',
        description: 'Detailed insights and tracking to show exactly how your GMB profile is performing.',
        icon: <FaChartLine />,
    },
    {
        title: 'Complete Optimization',
        description: 'From photos to reviews, we handle every detail of your local digital presence.',
        icon: <FaCheckDouble />,
    },
];

const LocalSeoWhyChoose = () => {
    return (
        <section className="relative bg-black pt-20 py-0 md:py-30 overflow-hidden">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Why Choose Us</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                DOMINATE YOUR <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">NEIGHBOR<br/>HOOD.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                We turn local searches into local customers with a strategic approach to Google My Business and Map rankings.
                            </p>
                        </motion.div>
                    </div>
...
export default LocalSeoWhyChoose;
