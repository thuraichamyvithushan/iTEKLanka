...
const features = [
    {
        title: 'Authentic ROI',
        description: 'We focus on leads and sales, not just vanity rankings. If the traffic doesn\'t help you grow, it doesn\'t matter to us.',
        icon: <FaUserCheck />,
    },
    {
        title: 'SL Business Focus',
        description: 'We know how people search in Sri Lanka. We tailor your strategy to capture the local market and beat your nearby competitors.',
        icon: <FaMapMarkedAlt />,
    },
    {
        title: 'Honest Partnership',
        description: 'No hidden fees or "black-hat" tricks that get you banned. We use safe, long-term methods that Google loves.',
        icon: <FaHandshake />,
    },
];
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                REAL PEOPLE. <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">REAL RANKINGS.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                SEO is a marathon, not a sprint. We help you build a solid digital foundation that brings in customers for years to come.
                            </p>
                        </motion.div>
                    </div>
