...
import {
  FaSearchLocation, FaKeyboard, FaCode, FaChartLine, FaFileAlt, FaGlobe
} from 'react-icons/fa';

const services = [
  {
    title: 'Local SEO',
    description: 'We optimize your Google Business profile and maps, making sure customers in your Sri Lankan neighborhood find you first.',
    icon: <FaSearchLocation className="text-5xl" />,
    accent: 'red-600'
  },
  {
    title: 'Keyword Strategy',
    description: 'We find the exact words your customers are typing into Google, so your business shows up exactly when they are ready to buy.',
    icon: <FaKeyboard className="text-5xl" />,
    accent: 'rose-600'
  },
  {
    title: 'On-Page SEO',
    description: 'Every button, title, and image on your site will be fine-tuned to tell Google exactly what you offer and why you are the best.',
    icon: <FaGlobe className="text-5xl" />,
    accent: 'red-500'
  },
  {
    title: 'Technical SEO',
    description: 'We fix the invisible technical issues like slow speeds and broken links that might be stopping your site from ranking properly.',
    icon: <FaCode className="text-5xl" />,
    accent: 'rose-500'
  },
  {
    title: 'Content Marketing',
    description: 'Writing helpful, human-centered articles that people actually want to read, building trust while improving your search rankings.',
    icon: <FaFileAlt className="text-5xl" />,
    accent: 'red-700'
  },
  {
    title: 'Monthly Reporting',
    description: 'No secrets here. We provide clear, honest reports every month showing your growth, your rankings, and your real business results.',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-12 md:mb-30">
          ...
          <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
            SEO <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">SERVICES</span>
          </h2>
          ...
          <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
            Honest, ROI-driven strategies designed to help you dominate your industry and reach the next level.
          </p>
        </div>
