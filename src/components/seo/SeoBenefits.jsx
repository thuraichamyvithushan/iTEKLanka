...
const benefits = [
    {
        ...
        description: 'Stop paying for every click. We help you earn natural, free traffic from Google that keeps coming in 24/7.'
    },
    {
        title: 'HIGHER CONVERSION RATES',
        description: 'We don\'t just bring in people; we bring in the right people who are actively looking for exactly what you sell.'
    },
    {
        title: 'LONG-TERM BRAND DOMINANCE',
        description: 'Ranking at the top of Google instantly labels you as a leader in your industry in Sri Lanka, building massive trust.'
    }
];
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <h3 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter uppercase leading-[0.8] italic">
                                GROW <br />
                                <span className="text-red-600">ORGANICALLY</span>
                            </h3>

                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Good SEO is an investment that pays for itself many times over by reducing your dependency on expensive ads.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">4.2<span className="text-2xl">x</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Traffic Boost</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">24/7</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Active Presence</div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="text-5xl font-black mb-1">TOP</div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Your SEO Advantage</span>
                            </div>
