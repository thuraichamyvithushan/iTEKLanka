...
const seoFaqs = [
    {
        ...
        answer: "SEO is a medium to long-term strategy. Typically, you can expect to see noticeable improvements in rankings and traffic within 3 to 6 months, depending on your industry competition."
    },
    {
        question: "Do you guarantee #1 ranking on Google?",
        answer: "No honest SEO agency can guarantee a #1 spot, as Google updates its rules constantly. We guarantee that we will follow best practices to maximize your chances and deliver genuine ROI-driven results."
    },
    {
        question: "What is Local SEO and do I need it?",
        answer: "Local SEO focuses on making your business show up when people search for services 'near me'. If you have a physical office or store in Sri Lanka, it is essential for bringing in foot traffic."
    },
    {
        question: "Will you provide reports on my progress?",
        answer: "Yes, we providing clear monthly reports that show your current rankings, organic traffic growth, and the work we've completed. No technical jargon—just honest results."
    },
    {
        question: "Do I need to keep doing SEO once I rank #1?",
        answer: "Google's rankings are competitive. If you stop, your competitors will keep working and eventually overtake you. Maintenance ensures you stay at the top and keep your lead."
    }
];
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    >
                        ...
                        <span className="text-red-700 font-semibold text-sm uppercase tracking-[0.3em]">SEO Inquiries</span>
                    </motion.div>
