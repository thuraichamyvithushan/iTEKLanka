...
const webDesignFaqs = [
    {
        ...
        answer: "Typically, a standard corporate website takes 3–6 weeks. However, more complex e-commerce or custom web applications can take 8–12 weeks depending on the specific requirements and integrations."
    },
    {
        question: "Will my website be mobile-friendly and responsive?",
        answer: "Absolutely. Every website we build is mobile-first and fully responsive, meaning it will look and perform flawlessly on smartphones, tablets, laptops, and large desktop screens."
    },
    {
        question: "Do you provide website maintenance and support?",
        answer: "Yes, we offer ongoing maintenance packages that include security updates, performance monitoring, regular backups, and content updates to ensure your site remains healthy and up-to-date."
    },
    {
        question: "Can I manage the website content myself?",
        answer: "We primarily build websites using user-friendly Content Management Systems (CMS) like WordPress or custom Dashboards, allowing you to easily update text, images, and blog posts without any technical knowledge."
    },
    {
        question: "Is SEO included in the web design process?",
        answer: "Every website we design includes basic on-page SEO optimization. We focus on search-engine-friendly architecture, fast loading speeds, and meta-tag optimization. We also offer advanced SEO growth packages."
    }
];
