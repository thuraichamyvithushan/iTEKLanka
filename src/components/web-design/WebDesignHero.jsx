      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 xl:gap-4 items-center">
          ...
          >
            ...
            <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black text-white leading-[0.82] tracking-[-0.04em] mb-4">
              BUILD
              <br />
            ...
            <p className="text-xl md:text-2xl text-gray-300/90 font-medium max-w-xl leading-relaxed mb-14">
              We create fast, beautiful websites that help brands in Sri Lanka and beyond stand out and grow.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <Link to="/contact">
                ...
                >
                  <span className="relative z-10">Let's Talk Shop</span>
          ...
          {/* Right – Visual showcase with glass effect */}
          <div className="relative mt-0 lg:mt-0">
            ...
            >
              ...
              <img
                src={heroImage}
                alt="Premium digital experience showcase"
                className="w-full h-auto object-cover scale-[1.04] transition-transform duration-[1200ms] group-hover:scale-105"
              />

              {/* Bottom status bar – premium touch */}
