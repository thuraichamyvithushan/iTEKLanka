                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-lg sm:text-xl mb-12 font-medium leading-relaxed">
                                We map every digital touchpoint to ensure your brand ranks where it matters most — at the top of the Sri Lankan market.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 relative z-10">
                                <div className="p-6 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl sm:text-5xl font-black text-gray-900 mb-2">94%</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Local Reach</div>
                                </div>
                                <div className="p-6 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl sm:text-5xl font-black text-gray-900 mb-2">2.4<span className="text-xl sm:text-2xl">x</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">CTR Growth</div>
                                </div>
                            </div>
                        </motion.div>


                        {/* Floating Metadata (Luxury detail) */}
                        <motion.div
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Execution Strategy</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                SEO IS NOT <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">AN AFTERTHOUGHT.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed mb-16 max-w-xl">
                                We bake SEO into the architectural DNA of every project. No bloat, minimal code, and lightning-fast headers optimized for future-proof growth.
                            </p>
...
export default WebDesignSeoContent;
