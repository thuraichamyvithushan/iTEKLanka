...
import {
  FaLaptopCode, FaMobileAlt, FaSearch, FaRocket, FaCogs, FaShieldAlt
} from 'react-icons/fa';

const services = [
  {
    title: 'Fits Any Screen',
    description: 'We make sure your site looks great on everything from smartphones to large office monitors.',
    icon: <FaMobileAlt className="text-5xl" />,
    accent: 'red-600'
  },
  {
    title: 'Easy to Use',
    description: 'We design simple, smooth paths for your customers, making it easy for them to take action.',
    icon: <FaLaptopCode className="text-5xl" />,
    accent: 'rose-600'
  },
  {
    title: 'Get Found',
    description: 'We set up your site so search engines like Google can find you easily, especially in your local area.',
    icon: <FaSearch className="text-5xl" />,
    accent: 'red-500'
  },
  {
    title: 'Fast Loading',
    description: 'Nobody likes a slow site. Ours load almost instantly, keeping your visitors happy and engaged.',
    icon: <FaRocket className="text-5xl" />,
    accent: 'rose-500'
  },
  {
    title: 'Custom Built',
    description: 'We build exactly what you need from the ground up, so your site works exactly the way you want.',
    icon: <FaCogs className="text-5xl" />,
    accent: 'red-700'
  },
  {
    title: 'Secure & Safe',
    description: 'We keep your site safe from threats with modern security and constant monitoring.',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-12 md:mb-30">
          ...
          <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10">
            THE <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">STANDARD</span>
          </h2>
          ...
          <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
            Precision-crafted digital foundations that outperform — engineered for ambitious brands that demand excellence.
          </p>
        </div>
