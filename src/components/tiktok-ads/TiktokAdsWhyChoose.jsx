...
const features = [
    {
        ...
        description: 'We focus on real interactions, not just vanity views. If the engagement doesn\'t lead to brand growth and sales, it doesn\'t matter to us.',
        icon: <FaUserCheck />,
    },
    {
        title: 'SL Audience Focus',
        description: 'We understand the Sri Lankan TikTok algorithm and what makes content go viral locally. We tailor your strategy to capture the active local market.',
        icon: <FaMapMarkedAlt />,
    },
    {
        title: 'Safe & Compliant',
        description: 'No fake followers, bots, or community guideline strikes. We use safe, trend-driven content strategies that the TikTok algorithm naturally loves.',
        icon: <FaHandshake />,
    },
];

const TiktokAdsWhyChoose = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                REAL TRENDS. <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">REAL VIRALITY.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                Social media changes fast. We help you build a highly adaptive, engaging presence that captures attention and converts viewers into loyal customers.
                            </p>
                        </motion.div>
                    </div>
...
export default TiktokAdsWhyChoose;
