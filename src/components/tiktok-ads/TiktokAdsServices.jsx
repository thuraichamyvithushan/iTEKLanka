...
import {
    FaVideo, FaHashtag, FaUsers, FaChartLine, FaMobileAlt, FaBullhorn
} from 'react-icons/fa';

const services = [
    {
        title: 'In-Feed Ads',
        description: 'We create highly engaging, native-looking videos that seamlessly blend into the "For You" page, driving instant action.',
        icon: <FaMobileAlt className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Hashtag Challenges',
        description: 'Spark viral trends and encourage user-generated content by launching branded challenges that capture the entire platform.',
        icon: <FaHashtag className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Influencer Collabs',
        description: 'We connect your brand with top Sri Lankan TikTok creators to build authentic trust and reach massive new audiences organically.',
        icon: <FaUsers className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Spark Ads',
        description: 'Boost existing organic videos from your profile or creators to maximize reach while maintaining pure authenticity.',
        icon: <FaBullhorn className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Video Production',
        description: 'Our creative team shoots and edits fast-paced, high-quality TikTok videos designed specifically for short attention spans.',
        icon: <FaVideo className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Ad Analytics',
        description: 'We monitor every view, click, and conversion with in-depth analytics to ensure your ad spend delivers maximum ROI.',
...
export default function TiktokAdsServices() {
    return (
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        TIKTOK <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">SERVICES</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Honest, ROI-driven strategies designed to help you dominate your industry and reach the next level on TikTok.
                    </p>
                </div>
