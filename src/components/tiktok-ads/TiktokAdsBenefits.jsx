...
const benefits = [
    {
        ...
        description: 'Stop fighting restrictive algorithms. TikTok allows even brand new Sri Lankan accounts to reach millions organically.'
    },
    {
        title: 'HIGHER ENGAGEMENT RATES',
        description: 'TikTok users don\'t just watch; they interact. We create content that stops the scroll and encourages immediate interaction and shares.'
    },
    {
        title: 'TREND-DRIVEN RELEVANCE',
        description: 'By jumping on established and emerging trends quickly, your brand instantly becomes modern, relatable, and culturally relevant.'
    }
];

const TiktokAdsBenefits = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <h3 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter uppercase leading-[0.8] italic">
                                GO <br />
                                <span className="text-red-600">VIRAL.</span>
                            </h3>

                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Effective TikTok marketing puts your brand directly in front of the most engaged, active audience on the internet.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">4.8<span className="text-2xl">x</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Higher Engagement</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">24/7</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Trend Monitoring</div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Your Growth Advantage</span>
                            </div>
...
export default TiktokAdsBenefits;
