...
export default function CaseStudies() {
  ...
  return (
    <section ref={sectionRef} className="relative bg-white py-20 md:py-35 overflow-hidden">
      {/* Light atmosphere synchronized with Web Design Portfolio */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        {/* Project Grid: 3-column layout matching Portfolio page */}
