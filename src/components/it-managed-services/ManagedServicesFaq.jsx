...
const itServicesFaqs = [
    {
        question: "Can you come to our office if there is an emergency?",
        answer: "Yes, we have engineers based in Sri Lanka who can visit your location for hands-on hardware fixes or network troubleshooting that cannot be done remotely."
    },
    {
        question: "Do you offer monthly maintenance plans?",
        answer: "We offer flat-fee monthly packages. This covers everything from software updates to security monitoring, so you have a predictable IT budget every month."
    },
    {
        question: "Can you help us move our local data to the cloud?",
        answer: "Absolutely. We specialize in stress-free cloud migrations. We'll move your files, emails, and apps to systems like Google Workspace or Microsoft Azure without losing data."
    },
    {
        question: "How fast do you respond when the internet goes down?",
        answer: "Our monitoring systems usually catch the problem before you do. For critical issues, our team starts working on a fix within 15-30 minutes of the alert."
    },
    {
        question: "Is cybersecurity included in your standard plan?",
        answer: "Every plan we offer includes basic security like firewalls and antivirus. We also offer advanced protection for businesses that handle sensitive client data."
    }
];

const ManagedServicesFaq = () => {
...
export default ManagedServicesFaq;
