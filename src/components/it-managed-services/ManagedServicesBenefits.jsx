...
const benefits = [
    {
        ...
        description: 'Proactive monitoring and maintenance reduce downtime, improve uptime, and ensure business systems operate consistently and efficiently every day.'
    },
    {
        title: 'STRONGER SECURITY PROTECTION',
        description: 'Managed security controls reduce cyber risks, protect sensitive data, and strengthen business resilience against evolving digital threats.'
    },
    {
        title: 'OPERATIONAL COST EFFICIENCY',
        description: 'Predictable IT management costs reduce unexpected expenses while improving system performance and long-term technology investments.'
    }
];

const ManagedServicesBenefits = () => {
    return (
        <section className="relative bg-black py-20 pt-0 md:pt-0 py-40 mt-0 overflow-hidden">
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                We handle the technical heavy lifting so you can focus on scaling your business in Sri Lanka.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    ...
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Active Support</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">99%</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Uptime Goal</div>
                                </div>
                            </div>
                        </motion.div>

                        {/* Floating Status (Luxury detail) */}
                        <motion.div
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Why Your Business Needs It</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                IT MANAGED <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">SERVICES</span>
                            </h2>
...
export default ManagedServicesBenefits;
