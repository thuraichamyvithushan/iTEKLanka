...
const features = [
    {
        title: 'ROAS Obsessed',
        description: 'We don\'t celebrate clicks or impressions. We only celebrate when your Return on Ad Spend (ROAS) hits your profitability targets.',
        icon: <FaUserCheck />,
    },
    {
        title: 'E-commerce Experts',
        description: 'We understand the unique challenges of selling online in Sri Lanka. We optimize not just your ads, but your product feed and tracking setup.',
        icon: <FaMapMarkedAlt />,
    },
    {
        title: 'Transparent Scaling',
        description: 'No hidden markups on your ad spend. We manage your budget honestly and show you exactly where every rupee went and what it generated.',
        icon: <FaHandshake />,
    },
];

const GoogleShoppingWhyChoose = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                E-commerce is cutthroat. You need an agency that treats your ad budget like their own money, forcing every campaign to prove its financial worth.
                            </p>
                        </motion.div>
                    </div>
...
export default GoogleShoppingWhyChoose;
