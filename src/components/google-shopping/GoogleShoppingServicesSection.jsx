...
import {
    FaShoppingCart, FaChartLine, FaTags, FaSyncAlt, FaSearchPlus, FaPercent
} from 'react-icons/fa';

const services = [
    {
        title: 'Feed Optimization',
        description: 'We optimize your product titles, descriptions, and images in the Merchant Center to ensure maximum visibility for high-intent searches.',
        icon: <FaSyncAlt className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Smart Bidding Strategy',
        description: 'We implement advanced Target ROAS bidding to ensure your budget is spent on clicks most likely to result in profitable sales.',
        icon: <FaChartLine className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Campaign Structuring',
        description: 'By segmenting your products based on performance and margins, we allocate budget efficiently to maximize your total profits.',
        icon: <FaTags className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Negative Keyword Filtering',
        description: 'We actively manage negative keywords to prevent your ads from showing on irrelevant searches, saving your ad spend.',
        icon: <FaSearchPlus className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Promotion Integration',
        description: 'We set up Merchant Promotions directly in your ads to highlight sales, free shipping, and discounts, increasing click-through rates.',
        icon: <FaPercent className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Conversion Tracking',
        description: 'Flawless tracking implementation to measure exactly how many sales your ads generated and calculate precise Return on Ad Spend.',
...
export default function GoogleShoppingServicesSection() {
    return (
                ...
                <div className="text-center mb-12 md:mb-30">
                    ...
                    >
                        ...
                        <span className="text-red-700 font-semibold text-sm uppercase tracking-[0.3em]">
                            OUR SHOPPING EXPERTISE
                        </span>
                    </motion.div>

                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        RETAIL <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">SERVICES</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Data-driven e-commerce advertising strategies designed specifically to get your products sold.
                    </p>
                </div>
