...
const features = [
    {
        title: 'Local Insight',
        description: 'We understand the Sri Lankan digital landscape. We know what Colombo talks about and what Jaffna likes.',
        icon: <FaUserShield />,
    },
    {
        title: 'Real-Time Response',
        description: 'Social trends move at light speed. We monitor and adapt your strategy in real-time to stay relevant.',
        icon: <FaClock />,
    },
    {
        title: 'Ethical Engagement',
        description: 'No bots, no fake likes. We focus on genuine human interactions that build sustainable brand value.',
        icon: <FaHandshake />,
    },
];

const SocialMarketingWhyChoose = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Why Trust Us</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                WHY PARTNER <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">WITH ITEK?</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                We treat your social channels like our own storefront. Our goal is to make your brand the most discussed name in your niche.
                            </p>
                        </motion.div>
                    </div>
...
export default SocialMarketingWhyChoose;
