...
import {
    FaShareAlt, FaComments, FaPenNib, FaChartLine, FaUsers, FaHashtag
} from 'react-icons/fa';

const services = [
    {
        title: 'Strategy & Roadmap',
        description: 'Bespoke social media blueprints designed to align with your business goals and audience behavior.',
        icon: <FaShareAlt className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Community Management',
        description: 'Active engagement with your audience to build trust, resolve queries, and foster brand loyalty.',
        icon: <FaComments className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Content Creation',
        description: 'High-impact visuals and compelling copy that tell your brand story and stop the scroll.',
        icon: <FaPenNib className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Influencer Outreach',
        description: 'Connecting your brand with key voices in the Sri Lankan market to expand your reach naturally.',
        icon: <FaUsers className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Hashtag Optimization',
        description: 'Strategic use of tags and trends to ensure your content reaches the right niches in Colombo and beyond.',
        icon: <FaHashtag className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Analytics & Reporting',
        description: 'Transparent tracking of growth, engagement, and reach to ensure continuous improvement.',
...
export default function SocialMarketingServices() {
    return (
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        SOCIAL <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">ECOSYSTEM</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Full-spectrum social media management designed to build high-authority brands and active communities.
                    </p>
                </div>
