...
import socialMediaBg from '../../assets/services/socialmediamarketing.jpg';

export default function SocialMarketingHero() {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 xl:gap-4 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-300/90 font-medium max-w-xl leading-relaxed mb-14">
                            Go beyond likes. We build comprehensive social media strategies that turn followers into advocates and community into growth for Sri Lankan brands.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-5">
                            <Link to="/contact">
                                ...
                                >
                                    <span className="relative z-10">Ignite Your Brand</span>
                    ...
                    <div className="relative mt-0 lg:mt-0">
                        ...
                        >
                            ...
                            <img
                                src={socialMediaBg}
                                alt="Social Media Marketing Sri Lanka"
                            ...
                            <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-black/80 to-transparent flex items-center justify-between px-10 text-xs font-mono text-white/70">
                                <div>STRATEGY • CONTENT • COMMUNITY</div>
