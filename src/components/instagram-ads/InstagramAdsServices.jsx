...
import {
    FaCameraRetro, FaPlayCircle, FaImages, FaShareSquare, FaTrophy, FaChartLine
} from 'react-icons/fa';

const services = [
    {
        title: 'Ads That Belong',
        description: 'We create ads that look like normal, engaging Instagram posts, so people actually stop to look instead of scrolling past.',
        icon: <FaCameraRetro className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Short Videos',
        description: 'We edit snappy, attention-grabbing videos for Reels and Stories that quickly explain why your business is great.',
        icon: <FaPlayCircle className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Beautiful Carousels',
        description: 'We design swipeable photo galleries that let you show off multiple products or tell a deeper story about your brand.',
        icon: <FaImages className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Easy Sharing',
        description: 'We make your ads look so good that people actually want to share them with their friends, spreading your name for free.',
        icon: <FaShareSquare className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Loyalty Building',
        description: 'We help you stay in front of people who already bought from you once, making sure you are the first brand they think of next time.',
        icon: <FaTrophy className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Honest Updates',
        description: 'No marketing fluff. We tell you exactly how many people looked at your visuals and how many actually bought something.',
...
export default function InstagramAdsServices() {
    return (
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        EYE <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">CATCHING</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Beautiful advertising tailored specifically for Instagram's highly visual audience. We handle the photography, videos, and daily spending.
                    </p>
                </div>
