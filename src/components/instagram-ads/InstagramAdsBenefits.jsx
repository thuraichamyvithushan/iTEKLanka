...
const benefits = [
    {
        ...
        description: 'Instead of trying to explain why your product is great with heavy paragraphs of text, we show them beautiful, high-quality images and videos that do the talking.'
    },
    {
        title: 'CONNECT WITH TRENDSETTERS',
        description: 'If you want to reach a younger, modern audience in Sri Lanka, Instagram is exactly where they hang out, discover new brands, and decide what to buy.'
    },
    {
        title: 'BUILD BRAND DESIRE',
        description: 'A great Instagram presence makes your business look premium and desirable. When people see you looking good consistently, they want to be part of what you are selling.'
    }
];

const InstagramAdsBenefits = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Instagram is your online storefront window. We make sure it's the absolute best looking shop on the street.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">4.1<span className="text-2xl">x</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">More Desire</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">24/7</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Aesthetics</div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                SILENT <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">SELLING</span>
                            </h2>
...
export default InstagramAdsBenefits;
