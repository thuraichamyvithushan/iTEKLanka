...
import betterway from '../../assets/brands/betterway.png';
import huntsman from '../../assets/brands/huntsman.png';
import PINKAUTO from '../../assets/brands/PINK-AUTO.webp';
import sagar from '../../assets/brands/sagar.png';
import vncoe from '../../assets/brands/vncoe.webp';



const partners = [
  { name: "Betterway", image: betterway },
  { name: "Huntsman Optics", image: huntsman },
  { name: "Pink Automative", image: PINKAUTO },
  { name: "Sagar Holdings", image: sagar },
  { name: "VNCoE", image: vncoe },
   { name: "Betterway", image: betterway },
  { name: "Huntsman Optics", image: huntsman },
  { name: "Pink Automative", image: PINKAUTO },
  { name: "Sagar Holdings", image: sagar },
