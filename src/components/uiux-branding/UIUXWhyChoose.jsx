...
import { FaFingerprint, FaLightbulb, FaHeart } from 'react-icons/fa';

const features = [
    {
        title: 'Detail Obsessed',
        description: 'We worry about every pixel and every font curve, ensuring your brand looks perfect on every device.',
        icon: <FaFingerprint />,
    },
    {
        title: 'Local Insights',
        description: 'We understand what Sri Lankan customers value, helping you create a brand that feels local but looks global.',
        icon: <FaLightbulb />,
    },
    {
        title: 'User-First Flow',
        description: 'We design for humans, not for robots. Your app or site will feel natural and instinctive to use.',
        icon: <FaHeart />,
    },
];
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                WE BUILD <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">BRANDS THAT LAST.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                Good design is not just about looking pretty; it is about building trust and making your business work better.
                            </p>
                        </motion.div>
                    </div>
