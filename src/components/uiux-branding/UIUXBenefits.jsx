...
const benefits = [
    {
        ...
        description: 'A professional, modern look makes customers feel safe and confident when choosing your services or products in Sri Lanka.'
    },
    {
        title: 'EASIER USER JOURNEYS',
        description: 'When things are easy to find and pretty to look at, people stay longer and buy more. We remove the road-blocks for your users.'
    },
    {
        title: 'UNBEATABLE BRAND IDENTITY',
        description: 'Be the first name that comes to mind. We create a style that sets you apart from your competitors and makes you recognizable.'
    }
];
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Good design is your best salesperson. We make sure your brand looks like a leader in its industry.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    ...
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Custom Design</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">3.5<span className="text-2xl">x</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Brand Appeal</div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Why Your Brand Needs It</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                UI/UX & <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">BRANDING</span>
                            </h2>
