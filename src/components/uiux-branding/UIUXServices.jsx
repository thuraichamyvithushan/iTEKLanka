...
import {
    FaPalette, FaCompass, FaLayerGroup, FaPenNib, FaObjectGroup, FaMagic
} from 'react-icons/fa';

const services = [
    {
        title: 'Logo & Identity',
        description: 'We design unique, memorable logos that represent your business values and stay in your customers minds.',
        icon: <FaPenNib className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Mobile App Design',
        description: 'Beautiful, easy-to-use screens and buttons that make using your mobile app a breeze for every user.',
        icon: <FaLayerGroup className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'User Experience (UX)',
        description: 'We maps out the smoothest paths for your customers, making sure they find what they need without confusion.',
        icon: <FaCompass className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Brand Style Guides',
        description: 'A complete set of colors and fonts for your business to make sure everything smells and looks like your brand.',
        icon: <FaPalette className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Interactive Prototypes',
        description: 'See and click through your design before we even start coding, so you can test your idea early.',
        icon: <FaObjectGroup className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Premium Typography',
        description: 'Carefully chosen fonts and layouts that make your brand look high-end and super professional.',
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10">
                        THE <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">DESIGN</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Beautiful, user-focused designs crafted to make your brand connect with customers in Sri Lanka and globally.
                    </p>
                </div>
