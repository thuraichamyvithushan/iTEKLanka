...
const benefits = [
    {
        ...
        description: 'Introduce your brand to millions of potential customers, ensuring that yours is the first name they think of when they are ready to buy.'
    },
    {
        title: 'UNMATCHED SCALE',
        description: 'Access inventory across the entire web—not just Google. Appear on top news sites, niche blogs, and popular mobile apps everywhere.'
    },
    {
        title: 'COST-EFFECTIVE IMPACT',
        description: 'Generate massive amounts of brand impressions and views at a significantly lower cost-per-thousand (CPM) than most other channels.'
    }
];
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <h3 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter uppercase leading-[0.8] italic">
                                GROW <br />
                                <span className="text-red-600">VISUALLY</span>
                            </h3>

                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Visual marketing isn't just about looking good—it's about building a familiar, trusted presence that drives long-term growth.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">90<span className="text-2xl">%</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Global Coverage</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">35<span className="text-2xl">M</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Sites & Apps</div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="text-5xl font-black mb-1">MAX</div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Your Display Advantage</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                WHY IT <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">DOMINATES</span>
                            </h2>
