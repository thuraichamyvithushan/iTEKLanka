...
import { FaEye, FaGlobe, FaChartBar } from 'react-icons/fa';

const features = [
    {
        title: 'Unrivaled Reach',
        description: 'Connect with over 90% of internet users worldwide as they browse their favorite blogs, news sites, and apps every single day.',
        icon: <FaGlobe />,
    },
    {
        title: 'Visual Authority',
        description: 'Build brand recognition and trust through beautifully designed imagery that tells your story more effectively than text alone ever could.',
        icon: <FaEye />,
    },
    {
        title: 'Strategic Placements',
        description: 'We don\'t just cast a wide net. We carefully select the specific websites and contexts that align with your brand and your audience\'s interests.',
        icon: <FaChartBar />,
    },
];

const DisplayWhyChoose = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Why iTek Display</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                VISUAL. <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">VICTORY.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                In a world full of noise, we make sure your brand is the one that stands out and stays remembered by your ideal audience.
                            </p>
                        </motion.div>
                    </div>
...
export default DisplayWhyChoose;
