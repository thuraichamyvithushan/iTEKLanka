...
const benefits = [
    {
        title: 'TALK TO YOUR ACTUAL CUSTOMERS',
        description: 'Almost everyone in Sri Lanka is on Facebook or Instagram. We help you find the people who actually want what you sell, instead of shouting into the void.'
    },
    {
        title: 'BETTER USE OF YOUR MONEY',
        description: 'Newspaper or TV ads are expensive and hard to track. With Facebook ads, every rupee is tracked. You will know exactly what you are getting for your money.'
    },
    {
        title: 'QUICK, CLEAR RESULTS',
        description: 'Unlike some marketing that takes months to show results, Facebook ads can start bringing in messages, website visits, and sales almost immediately.'
    }
];
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Facebook advertising is the most direct way to introduce your business to new people right in your own community.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">3.2<span className="text-2xl">x</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">More Leads</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">24/7</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Active Ads</div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                SMART <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">INVESTMENT</span>
                            </h2>
...
export default FacebookAdsBenefits;
