...
import {
    FaBullseye, FaImage, FaSyncAlt, FaChartPie, FaMobileAlt, FaHandHoldingUsd
} from 'react-icons/fa';

const services = [
    {
        title: 'Find Your People',
        description: 'We show your up-to-date business offers only to the people right here in Sri Lanka who are actively looking to buy from you.',
        icon: <FaBullseye className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Ads That Look Good',
        description: 'We create nice, honest post images and short videos that make people pause their scrolling and read what you have to say.',
        icon: <FaImage className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Gentle Reminders',
        description: 'If someone visits your website but forgets to buy, we show them a friendly ad a few days later to invite them back.',
        icon: <FaSyncAlt className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Instagram Included',
        description: 'Since Facebook owns Instagram, we run your ads on both apps at the same time, making sure you do not miss any younger customers.',
        icon: <FaMobileAlt className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Respecting Your Budget',
        description: 'You decide how much to spend. We keep a close eye on the money every single day, pausing what does not work and pushing what does.',
        icon: <FaHandHoldingUsd className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Clear Results',
        description: 'No complicated charts. We send you a monthly update showing exactly how much you spent and how many new customers you got.',
...
export default function FacebookAdsServices() {
    return (
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        OUR <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">WORK</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Straight-forward advertising tailored for Facebook. We manage the hard parts so you can focus on running your business.
                    </p>
                </div>
