...
import { FaUserCheck, FaMapMarkedAlt, FaHandshake } from 'react-icons/fa';

const features = [
    {
        title: 'Focus on Real Sales',
        description: 'Getting a thousand "likes" feels nice, but it does not pay the rent. We build ads designed specifically to bring you actual paying customers.',
        icon: <FaUserCheck />,
    },
    {
        title: 'We Know Sri Lanka',
        description: 'We know how people here think and what makes them click. We do not use generic, boring ads. We talk to your audience in a way that feels natural.',
        icon: <FaMapMarkedAlt />,
    },
    {
        title: 'No Hidden Tricks',
        description: 'We are completely open about where your budget goes. No confusing marketing talk and no surprise fees—just honest, straightforward partnership.',
        icon: <FaHandshake />,
    },
];

const FacebookAdsWhyChoose = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                HONEST WORK. <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">REAL RETURNS.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                We believe online advertising should be simple: show your business to the right people, tell them why you are great, and make it easy for them to contact you.
                            </p>
                        </motion.div>
                    </div>
...
export default FacebookAdsWhyChoose;
