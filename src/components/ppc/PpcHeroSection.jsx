...
import ppcbg from '../../assets/services/ppc1.avif';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 xl:gap-4 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-300/90 font-medium max-w-xl leading-relaxed mb-14">
                            We help Sri Lankan businesses generate high-quality leads immediately through data-driven Pay-Per-Click campaigns. Stop guessing and start scaling.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-5">
                            <Link to="/contact">
                                ...
                                >
                                    <span className="relative z-10">Scale Your Sales</span>
                    ...
                    <div className="relative mt-8 lg:mt-0">
                        ...
                        >
                            ...
                            <img
                                src={ppcbg}
                                alt="High-converting PPC campaigns"
