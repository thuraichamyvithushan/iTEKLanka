...
import {
    FaSearchDollar, FaBullseye, FaImage, FaMapMarkerAlt, FaVideo, FaChartLine
} from 'react-icons/fa';

const services = [
    {
        title: 'Search Ads',
        description: 'Capture highest-intent customers the moment they search for your products or services on Google.',
        icon: <FaSearchDollar className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Retargeting',
        description: 'Stay top-of-mind by showing targeted ads to users who previously visited your website but didn\'t convert.',
        icon: <FaBullseye className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Display Ads',
        description: 'Build brand awareness across millions of websites and apps with visually striking banner ads.',
        icon: <FaImage className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Local Services Ads',
        description: 'Dominate your local Sri Lankan market by appearing at the very top of Google for local service searches.',
        icon: <FaMapMarkerAlt className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Video Ads',
        description: 'Engage your audience on YouTube and partner sites with compelling video campaigns that drive action.',
        icon: <FaVideo className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'Conversion Tracking',
        description: 'We measure every click, call, and sale, ensuring your budget is spent on what actually brings you profit.',
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        PPC <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">SERVICES</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Data-driven advertising strategies built to generate immediate leads and maximize your return on ad spend.
                    </p>
                </div>
