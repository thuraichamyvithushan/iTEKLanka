...
const benefits = [
    {
        ...
        description: 'Unlike SEO, which takes time, PPC campaigns can start driving targeted traffic and leads to your site on day one.'
    },
    {
        title: 'PRECISE TARGETING',
        description: 'Reach exactly who you want, when you want. Target by location, age, interests, and precise search intent.'
    },
    {
        title: 'COMPLETE BUDGET CONTROL',
        description: 'You decide exactly how much to spend per day or month. We optimize the campaigns to get the most out of every rupee.'
    }
];
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <h3 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter uppercase leading-[0.8] italic">
                                SCALE <br />
                                <span className="text-red-600">PROFITABLY</span>
                            </h3>

                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Professional PPC management ensures you stop burning money on bad clicks and start acquiring profitable customers.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                ...
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">24h</div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">To Go Live</div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Your Ad Advantage</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-[0.85] uppercase">
                                SMART <br />
                                <span className="bg-gradient-to-r from-gray-400 to-gray-200 bg-clip-text text-transparent italic opacity-40 text-4xl md:text-7xl">SPENDING</span>
                            </h2>
