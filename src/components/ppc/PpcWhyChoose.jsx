...
const features = [
    {
        title: 'Authentic ROI',
        description: 'We focus on leads and sales, not just clicks. If the traffic doesn\'t help you grow, it doesn\'t matter to us.',
        icon: <FaUserCheck />,
    },
    {
        title: 'SL Business Focus',
        description: 'We know how people search in Sri Lanka. We tailor your ad strategy to capture the local market and beat your competitors.',
        icon: <FaMapMarkedAlt />,
    },
    {
        title: 'Honest Partnership',
        description: 'No hidden fees or wasted ad spend. We manage your budget carefully and transparently to maximize your returns.',
        icon: <FaHandshake />,
    },
];
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                PRECISION <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">TARGETING.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                We don't just spend your money. We invest it strategically to ensure every click brings you closer to your business goals.
                            </p>
                        </motion.div>
                    </div>
