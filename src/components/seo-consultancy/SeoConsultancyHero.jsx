...
import consultBg from '../../assets/services/seocon.avif'; 

export default function SeoConsultancyHero() {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 xl:gap-8 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-300/90 font-medium max-w-xl leading-relaxed mb-14">
                            We don't just "do" SEO—we partner with your leadership to build a sustainable, long-term search strategy that dominates your market in Sri Lanka.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-5">
                            <Link to="/contact">
                                ...
                                >
                                    <span className="relative z-10">Let's Strategize</span>
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <img
                                src={consultBg}
                                alt="Strategic SEO consulting session"
                            ...
                            <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-black/80 to-transparent flex items-center justify-between px-10 text-xs font-mono text-white/70">
                                <div>STRATEGY • GROWTH • ADVICE</div>
