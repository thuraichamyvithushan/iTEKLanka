...
import { FaGraduationCap, FaNetworkWired, FaCommentsDollar } from 'react-icons/fa';

const whyUsPoints = [
    {
        title: 'Decades of Depth',
        description: 'Our consultants have seen the search landscape evolve over 10+ years. We bring seasoned insight that generic agencies lack.',
        icon: <FaGraduationCap />,
    },
    {
        title: 'Straight Talk',
        description: 'No technical smoke and mirrors. We give you honest, direct advice on what will work and what is a waste of your marketing budget.',
        icon: <FaCommentsDollar />,
    },
    {
        title: 'Strategic Integration',
        description: 'We don\'t work in a vacuum. We ensure your SEO strategy integrates perfectly with your wider business objectives.',
        icon: <FaNetworkWired />,
    },
];

const SeoConsultancyWhyTrust = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">Why iTek Consulting?</span>
                            </div>

                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                PARTNER <br />SHIP <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic text-4xl md:text-7xl">OVER PROJECTS.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                We are your fractional SEO directors. We provide the expertise you need to make winning decisions in a complex digital world.
                            </p>
                        </motion.div>
                    </div>
...
export default SeoConsultancyWhyTrust;
