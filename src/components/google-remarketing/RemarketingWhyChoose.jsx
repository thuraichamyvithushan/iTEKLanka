...
import { FaBullseye, FaAward, FaCheckCircle } from 'react-icons/fa';

const features = [
    {
        title: 'Precision Targeting',
        description: 'We don\'t waste your budget on random impressions. We target only the people who have shown real interest in your specific offerings, ensuring every rupee counts.',
        icon: <FaBullseye />,
    },
    {
        title: 'Brand Reinforcement',
        description: 'Stay top-of-mind by appearing on premium sites across the web. We make your business look as professional and established as it truly is.',
        icon: <FaAward />,
    },
    {
        title: 'Conversion Focused',
        description: 'Our remarketing isn\'t just about reminding people; it\'s about giving them a clear, compelling reason to come back and finish their purchase.',
        icon: <FaCheckCircle />,
    },
];

const RemarketingWhyChoose = () => {
    return (
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tight mb-10 uppercase">
                                PRECISION. <br />
                                <span className="bg-gradient-to-r from-red-500 via-rose-500 to-red-600 bg-clip-text text-transparent italic">PERSUASION.</span>
                            </h2>

                            <p className="text-gray-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl">
                                Don't let your marketing efforts go to waste. Remarketing is the second chance you need to turn window shoppers into lifelong customers.
                            </p>
                        </motion.div>
                    </div>
...
export default RemarketingWhyChoose;
