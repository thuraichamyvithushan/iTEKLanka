...
import {
    FaGlobe, FaShoppingBag, FaSearch, FaYoutube, FaEnvelope, FaMobileAlt
} from 'react-icons/fa';

const services = [
    {
        title: 'Standard Remarketing',
        description: 'Show ads to your past visitors as they browse other websites and apps, keeping your brand in their mind until they are ready to return.',
        icon: <FaGlobe className="text-5xl" />,
        accent: 'red-600'
    },
    {
        title: 'Dynamic Ads',
        description: 'Scale your results with ads that automatically show the specific products or services your visitors viewed on your site.',
        icon: <FaShoppingBag className="text-5xl" />,
        accent: 'rose-600'
    },
    {
        title: 'Search Retargeting',
        description: 'Appear at the top of Google results when past visitors search for your keywords again, capturing them at their highest intent moments.',
        icon: <FaSearch className="text-5xl" />,
        accent: 'red-500'
    },
    {
        title: 'Video Retargeting',
        description: 'Re-engage viewers who interacted with your YouTube channel or videos, turning casual watchers into loyal customers through visual storytelling.',
        icon: <FaYoutube className="text-5xl" />,
        accent: 'rose-500'
    },
    {
        title: 'Customer Match',
        description: 'Reach your existing leads and customers across Google Search, Gmail, and YouTube by securely using your own contact lists.',
        icon: <FaEnvelope className="text-5xl" />,
        accent: 'red-700'
    },
    {
        title: 'App Engagement',
        description: 'Bring users back to your mobile app with targeted ads designed to drive specific actions and increase lifetime value.',
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        REMARKETING <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">STRATEGIES</span>
                    </h2>
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Smart, strategic ways to bring your audience back home and finish what they started.
                    </p>
                </div>
