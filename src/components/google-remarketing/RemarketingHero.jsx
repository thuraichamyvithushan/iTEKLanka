...
import remarketingbg from '../../assets/services/googleremarketing.webp';

export default function RemarketingHero() {
    ...
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden bg-black pt-34 pb-32">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 xl:gap-12 items-center">
                    {/* Left Text */}
                    <motion.div
                    ...
                    >
                        <div className="inline-flex items-center gap-3 px-5 mt-2 py-2.5 bg-white/5 backdrop-blur-md border border-white/8 rounded-full mb-10">
                            ...
                            <span className="text-red-400/90 font-semibold text-xs uppercase tracking-[0.2em]">
                                RECAPTIVATE YOUR AUDIENCE
                            </span>
                        </div>

                        <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-8xl xl:text-9xl font-black text-white leading-[0.82] tracking-[-0.04em] mb-4 uppercase">
                            CONVERT
                            <br />
                        ...
                        <p className="text-xl md:text-2xl text-gray-300/90 font-medium max-w-xl leading-relaxed mb-14">
                            Don't let interested visitors slip away. We help you stay top-of-mind with previous visitors, gently guiding them back to your business when they're finally ready to buy.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-5">
                            <Link to="/contact">
                                ...
                                >
                                    <span className="relative z-10">Bring Them Back</span>
                    ...
                    <div className="relative mt-0 lg:mt-0">
                        ...
                        >
                            ...
                            <img
                                src={remarketingbg}
                                alt="Effective Google Remarketing"
                            ...
                            <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-black/80 to-transparent flex items-center justify-between px-10 text-xs font-mono text-white/70">
                                <div>RETARGET • REENGAGE • CONVERT</div>
                                <div className="flex items-center gap-4">
                                    <div className="flex gap-1.5">
                                        <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
                                        <div className="w-2 h-2 rounded-full bg-emerald-400/40" />
                                    </div>
                                    <span>99% RECALL RATE</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
