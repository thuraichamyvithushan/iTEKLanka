...
const remarketingFaqs = [
    {
        question: "Is remarketing better than regular ads?",
        answer: "In many cases, yes. Because you're reaching people who have already visited your site and expressed interest, they are much more likely to convert, which typically results in a much higher ROI."
    },
    {
        question: "Won't it annoy my potential customers?",
        answer: "Not with our approach. We use precise 'frequency capping' to ensure your ads are seen enough to be remembered, but not so often that they become intrusive. It's about being a helpful reminder, not a nuisance."
    },
    {
        question: "How soon will I see results?",
        answer: "Since you're targeting people who are already in your marketing funnel, you can often see a boost in conversions almost as soon as the campaign goes live and your lists reach minimum size."
    },
    {
        question: "Can I show different ads to different people?",
        answer: "Absolutely. We can segment your audience based on what they did on your site—showing one ad to someone who put an item in their cart, and a different one to someone who just read a blog post."
    },
    {
        question: "Does this work for small businesses in Sri Lanka?",
        answer: "Yes, remarketing is actually one of the most cost-effective strategies for smaller businesses because you're only spending ad budget on people who have already shown interest in you, minimizing waste."
    }
];

const RemarketingFaq = () => {
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6">
                <div className="text-center mb-12 md:mb-30">
                    ...
                    <h2 className="text-6xl md:text-9xl font-black text-gray-900 leading-none tracking-[-0.04em] mb-10 uppercase">
                        REMARKETING <span className="bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent italic">EXPLAINED</span>
                    </h2>
