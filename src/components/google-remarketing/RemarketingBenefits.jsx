...
const benefits = [
    {
        ...
        description: 'Remarketing often has much higher conversion rates compared to regular display ads because you\'re reaching people who already know your brand.'
    },
    {
        title: 'DYNAMIC PERSONALIZATION',
        description: 'Tailor your message based on exactly what the user was looking at, creating a highly personal and persuasive ad experience that feels human.'
    },
    {
        title: 'BROAD REACH, LOW COST',
        description: 'Reach people across millions of websites and apps at a cost-per-click that is often lower than competitive search keywords.'
    }
];
                    ...
                    <div className="w-full lg:w-1/2 relative group">
                        ...
                        >
                            ...
                            <h3 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 tracking-tighter uppercase leading-[0.8] italic">
                                SCALE <br />
                                <span className="text-red-600">STRATEGICALLY</span>
                            </h3>

                            <p className="text-gray-600 text-xl mb-12 font-medium leading-relaxed">
                                Remarketing is the missing piece in most digital strategies, bridging the gap between awareness and action.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 relative z-10">
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">70<span className="text-2xl">%</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Conversion Lift</div>
                                </div>
                                <div className="p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-red-500/30 transition-all duration-500 shadow-sm">
                                    <div className="text-4xl md:text-5xl font-black text-gray-900 mb-2">51<span className="text-2xl">%</span></div>
                                    <div className="text-red-600 font-black text-xs uppercase tracking-[0.2em]">Higher CTR</div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="text-5xl font-black mb-1">REAL</div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-md border border-white/10 rounded-full mb-8">
                                ...
                                <span className="text-red-400 font-semibold text-xs uppercase tracking-[0.2em]">The Remarketing Edge</span>
                            </div>
